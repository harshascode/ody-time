export default {
	...
	url: `https://ody-time.vercel.app`, // No trailing slash!
	name: `Odysseyyy`, // The short name of the business or brand name. Used for things like the copyright in the footer.
